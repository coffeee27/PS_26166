...
SAMPLES = (
    ...
    Sample(
        id="zoom-gap-5m",
        title="Zoom gap: 5 m vs 1 m (moderate)",
        title_hi="ज़ूम अंतर: 5 मी बनाम 1 मी (मध्यम)",
        description="Same area, but the OHRC image is shrunk to 5 m per pixel, about the detail of the TMC-2 camera. It still aligns, but some parts are weaker.",
        reference_label="NASA LRO NAC photo · 1 m per pixel",
        source_label="Chandrayaan-2 OHRC photo · shrunk to 5 m per pixel",
        reference="vikram_site/nac_ortho/vikram_landing_site_2km.tif",
        source="demo_zoom_gap/ohrc_5m.tif",
    ),
    Sample(
        id="half-overlap",
        title="Half overlap (moderate)",
        title_hi="आधा ओवरलैप (मध्यम)",
        description="Only the right half of the OHRC image is used, so half of the NAC photo has nothing to match. What aligns is accurate, but the other half has no proof.",
        reference_label="NASA LRO NAC photo · 1 m per pixel",
        source_label="Chandrayaan-2 OHRC photo · right half only",
        reference="vikram_site/nac_ortho/vikram_landing_site_2km.tif",
        source="demo_half_overlap/ohrc_east_half.tif",
    ),
    Sample(
        id="different-spots",
